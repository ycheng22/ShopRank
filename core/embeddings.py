...
async def embed_documents(texts: list[str], dim: int = 768, cache_dir: str = "data/embeddings_cache") -> np.ndarray:
...
async def embed_query(text: str, dim: int = 768, cache_dir: str = "data/embeddings_cache") -> np.ndarray:
